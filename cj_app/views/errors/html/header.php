...
<div id="header-wrap">
        ...
        <div class="container clearfix">
            ...
            <div id="logo">
                ...
                <a href="<?php echo base_url();?>" class="retina-logo" data-dark-logo="<?php echo base_url();?>images/logo-dark@2x.png"><img src="<?php echo base_url();?>images/logo@2x.png" alt="Times and Seasons Bible"></a>
            </div><!-- #logo end -->
